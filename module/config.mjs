...
PC.ammo = {
  ...
  group: {
    ...
    dart: { label: "PC.ammo.group.dart" },
    gasoil: { label: "PC.ammo.group.gasoil" },
    harpoon: { label: "PC.ammo.group.harpoon" },
    heavyArrow: { label: "PC.ammo.group.heavyArrow" },
    ...
    dynamo: { label: "PC.ammo.group.dynamo" },
