...
export default class AmmoSheet extends ParsCrucisItemSheet {
  ...
  static PARTS = {
    header: {
      template: `systems/pars-crucis/templates/item/ammo/header.hbs`,
    },
    tabs: {
    ...
    config: {
      template: "systems/pars-crucis/templates/item/ammo/config.hbs",
      classes: ["pc-item-tab"],
    },
  };
